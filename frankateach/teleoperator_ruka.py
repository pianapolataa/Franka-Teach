...
#             motor_positions[:14] = [1872.99, 2540.,   1617.,   1860.,   1792.78, 2900.,   1700, 1903, 1817, 2990, 2959, 1444,  765, 1414]
#             motor_positions[15] = 1630
...
class RukaOperator:
    ...
    def _apply_retargeted_angles(self) -> None:
        ...
        if self.start_teleop:
            ...
            move_to_pos(curr_pos=curr_pos, des_pos=motor_positions, hand=self.handler.hand, traj_len=35)
